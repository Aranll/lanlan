package com.xiaosuokeji.yilan.mobile.enumeration;
...
//  2.7 更新用户
    USER_UPDATE("/api/app/v1/update"),
//  2.8 更新用户密码
    USER_PASSWORD_UPDATE("/api/app/v1/user/password/update"),
//  2.9 获取用户会员信息
    USER_VIP_GET("/api/app/v1/user/vip/get"),
//  2.10 校验验证码
    USER_PASSWORD_FORGET_CAPTCHA_VERIFY("/api/app/v1/user/password/forget/captcha/verify"),
...
//  3.5 获取网站
    WEBSITE_LIST("/api/app/v1/website/list"),
...
//    9.6 获取图书列表
    BOOK_LIST("/api/app/v1/book/list"),
