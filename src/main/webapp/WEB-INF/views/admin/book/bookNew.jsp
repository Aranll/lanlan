                ...
                <form class="form-horizontal" id="form">
                    ...
                    <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <input name="publishDate" type="text" class="form-control datepicker" maxlength="20">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                    ...
                    <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <input name="category.name" type="text" onclick="showMenu(this,0,2)"
                                       class="form-control">
                    ...
                    <div class="col-xs-12 col-md-6 b  line-dashed wrapper-sm padder">
                        <div class="row">
                            ...
                            <input id="pdf" type="hidden" name="pdf" multiple="multiple"/>
                        </div>
                    </div>
                    <div class="col-xs-12 b line-dashed wrapper-sm padder">
                        <div class="row m-b-sm">
                            <div class="col-xs-12">
                                <label class="control-label">简介：
                                </label>
                            </div>
                        </div>
                        <div class="row">
...
<script>
    ...
    $form.validate({
        ...
        submitHandler: function (form) {
            doPost("<%=request.getContextPath()%>/admin/book/book/save", $(form).serialize(), function (data) {
                if (data.status) {
