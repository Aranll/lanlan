...
<html>
<head>
    <title>医览网-系统管理-文章管理-编辑文章</title>
...
<div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                ...
                <button class="btn btn-info pull-right" style="margin-top: -3px;margin-right: 5px"
                        onclick="submitForm()">
                    确定
                </button>
            </div>
...
<script>
    ...
    $form.validate({
        ...
        submitHandler: function (form) {
            ...
            doPost("<%=request.getContextPath()%>/admin/system/article/update", $(form).serialize(), function (data) {
                if (data.status) {
