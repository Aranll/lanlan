    ...
    <div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">讲坛分类</h1>
            </div>
            <div class="wrapper-md">
                <form class="form-horizontal" id="searchForm">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                            <input type="text" onclick="showMenu(this,1,1)" class="form-control">
                    ...
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${sessionScope.sec_op.video_category_save})">
                    ...
                    <table class="table text-center table-bordered table-striped m-b-none">
                        ...
                        <c:forEach items="${videos}" var="video">
                            <tr>
                                ...
                                <td>${video.statusDesc}</td>
                                <td>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.video_category_get})">
                                    <button class="btn btn-warning btn-xs" onclick="detailsVideo(${video.id})">
                                        详情
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.video_category_update})">
                                    <button class="btn btn-info btn-xs" onclick="updateVideo(${video.id})">
                                        编辑
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.video_category_remove})">
                                    <button class="btn btn-danger btn-xs"
                                            onclick="remove(${video.id},'<%=request.getContextPath()%>/admin/video/videoCategory/remove')">
                                        删除
                                    </button>
                                    </sec:authorize>
                                </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">新增讲坛分类</h4>
                </div>
...
//                digits: "所属是个编号"
        ...
        //使用ajax提交表单，保存讲坛分类
        function submitSave() {
            doPost("<%=request.getContextPath()%>/admin/video/videoCategory/save", $saveForm.serialize(), function (data) {
                if (data.status) {
...
//                    },600);
    ...
    <%--讲坛详情--%>
    <div class="modal fade" id="detailsVideo" data-backdrop="static" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
    ...
    <script type="text/javascript">
        ...
        var detailsVideoId;
        function detailsVideo(id) {
            detailsVideoId = id;
            //获取讲坛信息
            doPost("<%=request.getContextPath()%>/admin/video/videoCategory/get", {id: detailsVideoId}, function (data) {
                var _data = data.data;
                if (data.status) {
            ...
            $("#detailsVideo").modal("show");
        }
        function submitDetails() {
            $("#detailsVideo").modal("hide");
        }
    </script>
    <%--讲坛详情结束--%>

    <%--编辑讲坛开始--%>
    <div class="modal fade" id="updateVideo" data-backdrop="static" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
    ...
    <script type="text/javascript">
        ...
        function updateVideo(id) {
            ...
            $updateForm[0].reset();
            //获取讲坛信息
            doPost("<%=request.getContextPath()%>/admin/video/videoCategory/get", {id: updateVideoId}, function (data) {
                var _data = data.data;
                if (data.status) {
        ...
        function submitUpdate() {
            doPost("<%=request.getContextPath()%>/admin/video/videoCategory/update", $updateForm.serialize(), function (data) {
                if (data.status) {
                    $("#info_success").modal("show");
                    setTimeout(function(){
                        window.location.reload(true);
    ...
    <script>
        ...
        var zTreeNodes = [];
        function asyncUrl() {
            return "<%=request.getContextPath()%>/admin/video/videoCategory/tree";
        }
