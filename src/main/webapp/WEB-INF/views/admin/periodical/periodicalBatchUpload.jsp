...
<body>
<sec:authorize access="hasAnyRole(${sessionScope.sec_op.miniApp_category_batchUpload})">
    ...
    <div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">期刊管理>文件批量上传</h1>
            </div>
                    ...
                    <div class="col-xs-12 col-md-6 col-center-block">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-md-8">
                                ...
                                <a class="btn btn-success pull-right m-r-sm" href="<%=request.getContextPath()%>/admin/periodical/template/download">模板下载</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    function templateUpload(){
        ...
        if (files && files[0]) {
            ...
            uploadFile('<%=request.getContextPath()%>/admin/periodical/template/upload', formData, function (data) {
                if(!data.status) {
                    $("#info").html(data.msg);
