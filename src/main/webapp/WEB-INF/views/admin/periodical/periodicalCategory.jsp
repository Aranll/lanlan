    ...
    <div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">期刊分类</h1>
            </div>
            <div class="wrapper-md">
                <form class="form-horizontal" id="searchForm">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                            <input type="text" onclick="showMenu(this,1)" name="parent.name" class="form-control" value="${parent.name}">
                    ...
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${sessionScope.sec_op.periodical_category_save})">
                    ...
                    <table class="table text-center table-bordered table-striped m-b-none">
                        ...
                        <c:forEach items="${periodicals}" var="periodical">
                            <tr>
                                ...
                                <td>${periodical.statusDesc}</td>
                                <td>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.periodical_category_get})">
                                    <button class="btn btn-warning btn-xs" onclick="detailsPeriodical(${periodical.id})">
                                        详情
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.periodical_category_update})">
                                    <button class="btn btn-info btn-xs" onclick="updatePeriodical(${periodical.id})">
                                        编辑
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.periodical_category_remove})">
                                    <button class="btn btn-danger btn-xs" onclick="remove(${periodical.id},'<%=request.getContextPath()%>/admin/periodical/periodicalCategory/remove')">
                                        删除
                                    </button>
                                    </sec:authorize>
                                </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">新增期刊分类</h4>
                </div>
...
//                digits: "所属是个编号"
        ...
        //使用ajax提交表单，保存期刊分类
        function submitSave() {
            doPost("<%=request.getContextPath()%>/admin/periodical/periodicalCategory/save", $saveForm.serialize(), function (data) {
                if (data.status) {
...
<sec:authorize access="hasAnyRole(${sessionScope.sec_op.periodical_category_get})">
    ...
    <script type="text/javascript">
        ...
        function detailsPeriodical(id) {
            ...
            //获取期刊信息
            doPost("<%=request.getContextPath()%>/admin/periodical/periodicalCategory/get", {id: detailsPeriodicalId}, function (data) {
                console.log(data);
                var _data = data.data;
                console.log(_data);
                if (data.status) {
...
<%--编辑期刊开始--%>
    ...
    <script type="text/javascript">
        ...
        function updatePeriodical(id) {
            ...
            $updateForm[0].reset();
            //获取期刊信息
            doPost("<%=request.getContextPath()%>/admin/periodical/periodicalCategory/get", {id: updatePeriodicalId}, function (data) {
                console.log(data);
                var _data = data.data;
                console.log(_data);
                if (data.status) {
        ...
        function submitUpdate() {
            doPost("<%=request.getContextPath()%>/admin/periodical/periodicalCategory/update", $updateForm.serialize(), function (data) {
                if (data.status) {
                    $("#info_success").modal("show");
                    setTimeout(function(){
                        window.location.reload(true);
