    ...
    <div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">公众号分类</h1>
            </div>
            <div class="wrapper-md">
                <form class="form-horizontal" id="searchForm">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                            <input type="text" onclick="showMenu(this,1)" name="parent.name" value="${parent.name}" class="form-control">
                    ...
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${sessionScope.sec_op.publicNumber_category_save})">
                    ...
                    <table class="table text-center table-bordered table-striped m-b-none">
                        ...
                        <c:forEach items="${publicNumbers}" var="publicNumber">
                            <tr>
                                ...
                                <td>${publicNumber.parent.name}</td>
                                <td>
                                ...
                                <td>${publicNumber.statusDesc}</td>
                                <td>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.publicNumber_category_get})">
                                    <button class="btn btn-warning btn-xs" onclick="detailsPublicNumber(${publicNumber.id})">
                                        详情
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.publicNumber_category_update})">
                                    <button class="btn btn-info btn-xs" onclick="updatePublicNumber(${publicNumber.id})">
                                        编辑
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.publicNumber_category_remove})">
                                    <button class="btn btn-danger btn-xs" onclick="remove(${publicNumber.id},'<%=request.getContextPath()%>/admin/publicNumber/publicNumberCategory/remove')">
                                        删除
                                    </button>
                                    </sec:authorize>
                                </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">新增公众号分类</h4>
                </div>
                <div class="modal-body">
                    <form name="saveForm" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input type="text" onclick="showMenu(this,1)" class="form-control">
...
//                digits: "所属是个编号"
        ...
        //使用ajax提交表单，保存公众号分类
        function submitSave() {
            doPost("<%=request.getContextPath()%>/admin/publicNumber/publicNumberCategory/save", $saveForm.serialize(), function (data) {
                if (data.status) {
...
<%--公众号详情--%>
    ...
    <script type="text/javascript">
        ...
        function detailsPublicNumber(id) {
            ...
            //获取公众号信息
            doPost("<%=request.getContextPath()%>/admin/publicNumber/publicNumberCategory/get", {id: detailsPublicNumberId}, function (data) {
                var _data = data.data;
                if (data.status) {
...
<sec:authorize access="hasAnyRole(${sessionScope.sec_op.publicNumber_category_update})">
    ...
    <script type="text/javascript">
        ...
        function updatePublicNumber(id) {
            ...
            $updateForm[0].reset();
            //获取公众号信息
            doPost("<%=request.getContextPath()%>/admin/publicNumber/publicNumberCategory/get", {id: updatePublicNumberId}, function (data) {
                console.log(data);
                var _data = data.data;
                console.log(_data);
                if (data.status) {
        ...
        function submitUpdate() {
            doPost("<%=request.getContextPath()%>/admin/publicNumber/publicNumberCategory/update", $updateForm.serialize(), function (data) {
                if (data.status) {
                    $("#info_success").modal("show");
                    setTimeout(function(){
                        window.location.reload(true);
