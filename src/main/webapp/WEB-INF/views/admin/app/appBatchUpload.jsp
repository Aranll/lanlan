...
<div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">程序管理>文件批量上传</h1>
            </div>
            ...
            <div class="wrapper-md">
                <form class="form-horizontal" id="templateForm"
                      action="<%=request.getContextPath()%>/admin/app/template/download" method="post">
...
<script type="text/javascript">
    ...
    function templateUpload() {
        ...
        if (files && files[0]) {
            ...
            uploadFile('<%=request.getContextPath()%>/admin/app/template/upload', formData, function (data) {
                if (!data.status) {
                    $("#info").html(data.msg);
