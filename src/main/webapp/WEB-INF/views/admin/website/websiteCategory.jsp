    ...
    <div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">网站分类</h1>
            </div>
            <div class="wrapper-md">
                <form class="form-horizontal" id="searchForm">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                            <input type="text" name="parent.name" onclick="showMenu(this,1,0)" class="form-control"
                                   value="${parent.name}">
                        ...
                        <div class="col-xs-4 col-md-2 col-lg-3 m-b-md">
                    ...
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${sessionScope.sec_op.website_category_save})">
                    ...
                    <table class="table text-center table-bordered table-striped m-b-none">
                        ...
                        <c:forEach items="${websites}" var="website">
                            <tr>
                                ...
                                <td>${website.statusDesc}</td>
                                <td>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.website_category_get})">
                                    <button class="btn btn-warning btn-xs" onclick="detailsWebsite(${website.id})">
                                        详情
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.website_category_update})">
                                    <button class="btn btn-info btn-xs" onclick="updateWebsite(${website.id})">
                                        编辑
                                    </button>
                                    </sec:authorize>
                                    <sec:authorize access="hasAnyRole(${sessionScope.sec_op.website_category_remove})">
                                    <button class="btn btn-danger btn-xs"
                                            onclick="remove(${website.id},'<%=request.getContextPath()%>/admin/website/websiteCategory/remove')">
                                        删除
                                    </button>
                                    </sec:authorize>
                                </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新增网站分类</h4>
            </div>
...
//                digits: "所属是个编号"
    ...
    //使用ajax提交表单，保存网站分类
    function submitSave() {
        doPost("<%=request.getContextPath()%>/admin/website/websiteCategory/save", $saveForm.serialize(), function (data) {
            if (data.status) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">网站分类详情</h4>
            </div>
            <div class="modal-body">
...
<script type="text/javascript">
    ...
    function detailsWebsite(id) {
        detailsWebsiteId = id;
        //获取网站信息
        doPost("<%=request.getContextPath()%>/admin/website/websiteCategory/get", {id: detailsWebsiteId}, function (data) {
            var _data = data.data;
            if (data.status) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">编辑网站分类</h4>
            </div>
            <div class="modal-body">
                <form name="updateForm" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-9">
                            <input type="text" name="parent.name" onclick="showMenu(this,1)" class="form-control"
                                  >
                            <input name="parent.id" type="hidden">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function updateWebsite(id) {
        ...
        $updateForm[0].reset();
        //获取网站信息
        doPost("<%=request.getContextPath()%>/admin/website/websiteCategory/get", {id: updateWebsiteId}, function (data) {
            var _data = data.data;
            if (data.status) {
    ...
    function submitUpdate() {
        doPost("<%=request.getContextPath()%>/admin/website/websiteCategory/update", $updateForm.serialize(), function (data) {
            if (data.status) {
                $("#info_success").modal("show");
                setTimeout(function(){
                    window.location.reload(true);
