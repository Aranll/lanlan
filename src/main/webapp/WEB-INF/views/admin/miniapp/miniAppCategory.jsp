    ...
    <div class="app-content ">
        <div class="app-content-body">
            <div class="bg-light lter b-b wrapper-md ">
                <h1 class="m-n font-thin h3">小程序分类</h1>
            </div>
            <div class="wrapper-md">
                <form class="form-horizontal" id="searchForm">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                            <input type="text" onclick="showMenu(this,1)" class="form-control" name="parent.name" value="${parent.name}">
                    ...
                    <div class="form-group m-t-n-md">
                        <div class="col-xs-12">
                            <sec:authorize access="hasAnyRole(${sessionScope.sec_op.miniApp_category_save})">
                        ...
                        <c:forEach items="${miniApps}" var="miniApp">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger btn-xs" onclick="remove(${miniApp.id},'<%=request.getContextPath()%>/admin/miniApp/miniAppCategory/remove')">
                                        删除
                                    </button>
                                </td>
                            </tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">新增小程序分类</h4>
                    </div>
                    <div class="modal-body">
                        <form name="saveForm" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="seq" type="text" class="form-control" value="${seq}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-xs-3 text-right">
...
//                digits: "所属是个编号"
            ...
            //使用ajax提交表单，保存小程序分类
            function submitSave() {
                doPost("<%=request.getContextPath()%>/admin/miniApp/miniAppCategory/save", $saveForm.serialize(), function (data) {
                    if (data.status) {
...
<sec:authorize access="hasAnyRole(${sessionScope.sec_op.miniApp_category_get})">
        ...
        <script type="text/javascript">
            ...
            function detailsMiniApp(id) {
                detailsMiniAppId = id;
                //获取小程序信息
                doPost("<%=request.getContextPath()%>/admin/miniApp/miniAppCategory/get", {id: detailsMiniAppId}, function (data) {
                    console.log(data);
                    var _data = data.data;
                    console.log(_data);
                    if (data.status) {
...
<sec:authorize access="hasAnyRole(${sessionScope.sec_op.miniApp_category_update})">
        <%--编辑小程序开始--%>
        ...
        <script type="text/javascript">
            ...
            function updateMiniApp(id) {
                ...
                $updateForm[0].reset();
                //获取小程序信息
                doPost("<%=request.getContextPath()%>/admin/miniApp/miniAppCategory/get", {id: updateMiniAppId}, function (data) {
                    console.log(data);
                    var _data = data.data;
                    console.log(_data);
                    if (data.status) {
            ...
            function submitUpdate() {
                doPost("<%=request.getContextPath()%>/admin/miniApp/miniAppCategory/update", $updateForm.serialize(), function (data) {
                    if (data.status) {
                        $("#info_success").modal("show");
                        setTimeout(function(){
                            window.location.reload(true);
        ...
        <script>
            ...
            var zTreeNodes = [];
            function asyncUrl() {
                return "<%=request.getContextPath()%>/admin/miniApp/miniAppCategory/tree";
            }
