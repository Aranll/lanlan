  ...
  load: function load(pdfDocument, scale) {
    ...
    firstPagePromise.then(function (pdfPage) {
      ...
      Promise.all([storePromise, pageModePromise]).then(function (_ref2) {
        ...
        var hash = _this5.viewerPrefs['defaultZoomValue'] ? 'zoom=' + _this5.viewerPrefs['defaultZoomValue'] : null;
        var sidebarView = _this5.viewerPrefs['sidebarViewOnLoad'];
        if (values.exists && _this5.viewerPrefs['showPreviousViewOnLoad']) {
          hash = 'page=' + values.page + '&zoom=' + (_this5.viewerPrefs['defaultZoomValue'] || values.zoom) + ',' + values.scrollLeft + ',' + values.scrollTop;
          sidebarView = sidebarView || values.sidebarView | 0;
        }
        if (pageMode && !_this5.viewerPrefs['disablePageMode']) {
